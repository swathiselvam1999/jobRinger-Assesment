    ...
    return (
        <div className='text-sm'>
            ...
            <div className='bg-[#d6eeee]'>
                ...
                <div className='flex justify-center py-5 bg-white md:bg-[#d6eeee]'>
                    <div className='grid grid-cols-4 gap-5 md:gap-20'>
                        <div className='flex flex-col justify-center'>
                            ...
                            <span className='text-2xl md:text-4xl text-center tracking-wider font-semibold'>38223</span>
                        </div>
                        <div className='flex flex-col justify-center'>
                            <span className='text-center pb-4 font-bold'>Jobs Filled</span>
                            <span className='text-2xl md:text-4xl text-center tracking-wider font-semibold'>15153</span>
                        </div>
                        <div className='flex flex-col justify-center'>
                            <span className='text-center pb-4 font-bold'>Employers</span>
                            <span className='text-2xl md:text-4xl text-center tracking-wider font-semibold'>24058</span>
                        </div>
                        <div className='flex flex-col justify-center'>
                            <span className='text-center pb-4 font-bold'>Active Users</span>
                            <span className='text-2xl md:text-4xl text-center tracking-wider font-semibold'>1475492</span>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex flex-col md:flex-row justify-center gap-10 py-5 px-20'>
